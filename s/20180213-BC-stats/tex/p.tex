...
\begin{frame}[t]{Clustering index}{}
	\begin{center}
		\includegraphics<1>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=1}
		\includegraphics<2>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=2}
		\includegraphics<3>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=4}
		\includegraphics<4>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=8}
		\includegraphics<5>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=16}
		\includegraphics<6>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=32}
		\includegraphics<7>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=64}
		\includegraphics<8>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=128}
		\includegraphics<9>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=256}
		\includegraphics<10>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=512}
		\includegraphics<11>[width=0.9\textwidth]{E_rnd-go-ci/freq_pivot=1024}
	\end{center}
\end{frame}
...
\begin{frame}[t]{Clustering index}{}
	\begin{center}
		\href{https://raw.githubusercontent.com/numpde/as/master/p/single-cell/20171130-BCXX/OUTPUT/E_rnd-go-ci/list_pivot\%3Dall_gonly\%3DTrue.txt}{[click for the list]}
	\end{center}
\end{frame}
