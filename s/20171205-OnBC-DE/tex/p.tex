...
\begin{frame}[plain,t]
	\begin{center}
		%\small
		%
		Differential expression in BC data
		%
		\\[1\baselineskip]
		\small
		RA
...
\begin{frame}[t]{GSE75688 BC dataset}{}
	\vspace{-1\baselineskip}
	\begin{center}
		\includegraphics<1>[width=0.9\textwidth]{de_full}
		\includegraphics<2>[width=0.9\textwidth]{de_zoom}
	\end{center}

% 	{\only<1>{%
% 		Cell mechanisms:
% 		differentiation, apoptosis, BRCA, DNA repair
% 	}}%
% 	{\only<2>{%
