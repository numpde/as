...
\begin{frame}[t]{Clustering index}{}
	\begin{center}
		\includegraphics<1>[width=0.8\textwidth]{E_rnd-go-ci/freq_1}
		\includegraphics<2>[width=0.8\textwidth]{E_rnd-go-ci/freq_2}
		\includegraphics<3>[width=0.8\textwidth]{E_rnd-go-ci/freq_4}
		\includegraphics<4>[width=0.8\textwidth]{E_rnd-go-ci/freq_8}
		\includegraphics<5>[width=0.8\textwidth]{E_rnd-go-ci/freq_16}
		\includegraphics<6>[width=0.8\textwidth]{E_rnd-go-ci/freq_32}
		\includegraphics<7>[width=0.8\textwidth]{E_rnd-go-ci/freq_64}
		\includegraphics<8>[width=0.8\textwidth]{E_rnd-go-ci/freq_128}
		\includegraphics<9>[width=0.8\textwidth]{E_rnd-go-ci/freq_256}
		\includegraphics<10>[width=0.8\textwidth]{E_rnd-go-ci/freq_512}
		\includegraphics<11>[width=0.8\textwidth]{E_rnd-go-ci/freq_1024}
	\end{center}
\end{frame}
